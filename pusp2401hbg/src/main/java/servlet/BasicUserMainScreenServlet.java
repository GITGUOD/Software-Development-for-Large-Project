...
@WebServlet("/BasicUserMainScreenServlet")
public class BasicUserMainScreenServlet extends HttpServlet {
    ...
    public BasicUserMainScreenServlet() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         */
            ...
            out.println("<html>");
            out.println(fga.headLayout("BasicUser"));
            ...
            out.println(formGenerator.getUserMainScreenForm());
